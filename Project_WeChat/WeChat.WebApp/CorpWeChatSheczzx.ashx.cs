...
namespace WeChat.WebApp
{
    ...
    public class CorpWeChatSheczzx : IHttpHandler
    {
        ...
        static CorpWeChatSheczzx()
        {
            ...
            CorpRecEventEnter_agent.OnEventEnter_agent += DoEnter_agent;
        }
        ...
        public static string DoClick(CorpRecEventClick instanse)
        {
            ...
            CorpSendMsgText msg = new CorpSendMsgText("开发中，敬请期待！", instanse.FromUserName);
            corpCoreSheczzx.SendMsg(msg);
            
            return "";
        }

        public static string DoEnter_agent(CorpRecEventEnter_agent instanse)
        {
            ...
            nm1.title = "实施单位用户注册";
            nm1.picurl = "http://www.shmecsfa.shec.edu.cn/Images/Loginimg.png";
            nm1.url = "http://www.shmecsfa.shec.edu.cn/UserInfo/CreateCorp";
